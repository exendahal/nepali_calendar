namespace nepali_calendar_picker.Data
{
    /// <summary>
    /// Authoritative day-count data for each BS year/month.
    /// Source: Government of Nepal official calendar publications.
    /// Coverage: BS 1970–2100.
    /// </summary>
    public static class BsCalendarData
    {
        ...
        private static readonly Dictionary<int, int[]> Data = new()
        {
            ...
            [2005] = [31, 32, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30],
            [2006] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
            [2007] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30],
            [2008] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31],
            [2009] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31],
            [2010] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
            [2011] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30],
            [2012] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30],
            ...
            [2018] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30],
            ...
            [2024] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30],
            [2025] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30],
            [2026] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31],
            [2027] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30],
            ...
            [2035] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30],
            ...
            [2048] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30],
            ...
            [2066] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30],
            ...
            [2096] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30],
            [2097] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
            [2098] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30],
            [2099] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],
            [2100] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
        };

        /// <summary>Returns the number of days in the given BS year/month (1-based month).</summary>
